...
HITBLOCKSOUNDS = {"199148933", "199148947"}
TAUNTS = {"368794227","368794903","368794985"}
UNANCHOR = true
...
function AoEDamage(position,radius,min,max,maxstrength,beserk,critrate,critmultiplier,CanBeDodgedByJumping,DoesWarp,Instakill,HasChain,modedamage)
							...
							if v:FindFirstChildOfClass("Humanoid") then
								...
								if HUMAN.Health ~= 0 then
									...
									elseif DoesWarp == true then
										...
										Warp(TORSO,Instakill,modedamage)
									else
...
local RIGHTSHOULDERC0 = RW
local LEFTSHOULDERC0 = LW
...
face = CreatePart(3, Weapon, "Neon", 0, 0, "Really black", "Face mask", VT(1.001,1.001,1.001),false)
faceweld = CreateWeldOrSnapOrMotor("Weld", face, Head, face, CF(0.02,0,0) * ANGLES(RAD(0), RAD(0), RAD(0)), CF(0, 0, 0))
MakeForm(face,"Head")
part = CreatePart(3, Weapon, "Neon", 0, 0, "Royal purple", "Eye", VT(0.4,0.25,0.2),false)
partweld = CreateWeldOrSnapOrMotor("Weld", part, Head, part, CF(0.15,0.28,-0.53) * ANGLES(RAD(15), RAD(0), RAD(25)), CF(0, 0, 0))
MakeForm(part,"Ball")
Eye = CreatePart(3, Weapon, "Neon", 0, 0, "Really black", "Eye", VT(0.1,0.1,0.15),false)
...
------	end
------	AoEDamage(Torso.Position,15,0,0,0,false,0,0,false,true,false,false,remode)
...
StarDivision()
elseif k == "z" and attack == false and ModeOfGlitch == 333 then
VoidChain()
elseif k == "c" and attack == false and ModeOfGlitch == 12345678987654322 then
UniversalSpark()
