...
---------------------------------------
script.lscript.re.Parent = script
script.lscript.Parent = Player.PlayerGui
script.REEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE.Parent = Player.PlayerGui
...
------------DIZZYFREDDBEAR SKIN PART------------
print("CREATE SteamGypsy")
SteamGypsyGROUP = Instance.new("Model",Character)
SteamGypsyGROUP.Parent = Character
SteamGypsyGROUP.Name = "SteamGypsy"
print(SteamGypsyGROUP.Name)
SteamGypsy = Instance.new("Part",SteamGypsyGROUP)
SteamGypsy.Size = Vector3.new(1.62, 1.15, 1.59)
SteamGypsy.Parent = SteamGypsyGROUP
SteamGypsy.Name = "SteamGypsy HANDLE"
SteamGypsy.Locked = true
SteamGypsy.Transparency = 1
SteamGypsy.CanCollide = false
SteamGypsyMesh = Instance.new("SpecialMesh",SteamGypsy)
SteamGypsyMesh.MeshId = "rbxassetid://101206200"
SteamGypsyMesh.TextureId = "rbxassetid://101206538"
SteamGypsyMesh.Offset = Vector3.new(0, 0.6, 0)
SteamGypsyWeld = Instance.new("Weld")
SteamGypsyWeld.Parent = SteamGypsyGROUP
SteamGypsyWeld.Part0 = SteamGypsy
SteamGypsyWeld.Part1 = Player.Character.Head
SteamGypsyWeld.C0 = CFrame.new(0,0,0) * CFrame.Angles(0, math.rad(0), 0)
print("CREATE Round Glasses")
Round_GlassesGROUP = Instance.new("Model",Character)
Round_GlassesGROUP.Parent = Character
Round_GlassesGROUP.Name = "Round Glasses"
print(Round_GlassesGROUP.Name)
Round_Glasses = Instance.new("Part",Round_GlassesGROUP)
Round_Glasses.Size = Vector3.new(1, 1, 1)
Round_Glasses.Parent = Round_GlassesGROUP
Round_Glasses.Name = "Round Glasses HANDLE"
Round_Glasses.Transparency = 1
Round_Glasses.Locked = true
Round_Glasses.CanCollide = false
Round_GlassesMesh = Instance.new("SpecialMesh",Round_Glasses)
Round_GlassesMesh.MeshId = "rbxassetid://22053998"
Round_GlassesMesh.TextureId = "rbxassetid://22053986"
Round_GlassesMesh.Offset = Vector3.new(0, 0.1, -0.17)
Round_GlassesWeld = Instance.new("Weld")
Round_GlassesWeld.Parent = Round_GlassesGROUP
Round_GlassesWeld.Part0 = Round_Glasses
Round_GlassesWeld.Part1 = Player.Character.Head
Round_GlassesWeld.C0 = CFrame.new(0,0,0) * CFrame.Angles(0, math.rad(0), 0)
print("CREATE BlackIronAntlers")
BlackIronAntlersGROUP = Instance.new("Model",Character)
BlackIronAntlersGROUP.Parent = Character
BlackIronAntlersGROUP.Name = "BlackIronAntlers"
print(BlackIronAntlersGROUP.Name)
BlackIronAntlers = Instance.new("Part",BlackIronAntlersGROUP)
BlackIronAntlers.Size = Vector3.new(1, 2, 1)
BlackIronAntlers.Parent = BlackIronAntlersGROUP
BlackIronAntlers.Name = "Round Glasses HANDLE"
BlackIronAntlers.Transparency = 1
BlackIronAntlers.Locked = true
BlackIronAntlers.CanCollide = false
BlackIronAntlersMesh = Instance.new("SpecialMesh",BlackIronAntlers)
BlackIronAntlersMesh.MeshId = "rbxassetid://398639215"
BlackIronAntlersMesh.TextureId = "rbxassetid://398639091"
BlackIronAntlersMesh.Offset = Vector3.new(0, 0.9, 0)
BlackIronAntlersWeld = Instance.new("Weld")
BlackIronAntlersWeld.Parent = BlackIronAntlersGROUP
BlackIronAntlersWeld.Part0 = BlackIronAntlers
BlackIronAntlersWeld.Part1 = Player.Character.Head
BlackIronAntlersWeld.C0 = CFrame.new(0,0,0) * CFrame.Angles(0, math.rad(0), 0)
print("CREATE LeatherWizardHat")
LeatherWizardHatGROUP = Instance.new("Model",Character)
LeatherWizardHatGROUP.Parent = Character
LeatherWizardHatGROUP.Name = "LeatherWizardHat"
print(LeatherWizardHatGROUP.Name)
LeatherWizardHat = Instance.new("Part",LeatherWizardHatGROUP)
LeatherWizardHat.Size = Vector3.new(3, 1.6, 3)
LeatherWizardHat.Parent = LeatherWizardHatGROUP
LeatherWizardHat.Name = "Round Glasses HANDLE"
LeatherWizardHat.Transparency = 1
LeatherWizardHat.Locked = true
LeatherWizardHat.CanCollide = false
LeatherWizardHatMesh = Instance.new("SpecialMesh",LeatherWizardHat)
LeatherWizardHatMesh.MeshId = "rbxassetid://12811687"
LeatherWizardHatMesh.TextureId = "rbxassetid://12811694"
LeatherWizardHatMesh.Offset = Vector3.new(0, 0.9, 0)
LeatherWizardHatWeld = Instance.new("Weld")
LeatherWizardHatWeld.Parent = LeatherWizardHatGROUP
LeatherWizardHatWeld.Part0 = LeatherWizardHat
LeatherWizardHatWeld.Part1 = Player.Character.Head
LeatherWizardHatWeld.C1 = CFrame.new(0,0,0) * CFrame.Angles(0, math.rad(90), 0)
LeatherWizardHat.Orientation = Vector3.new(0, 0, 0)
function hat_transparency(transparency)
	SteamGypsy.Transparency = transparency
	Round_Glasses.Transparency = transparency
	BlackIronAntlers.Transparency = transparency
	LeatherWizardHat.Transparency = transparency
end
hat_transparency(1)
------------------------------------------------
			...
			for i = 1, 35 do
				...
				for _, c in pairs(CLONE:GetDescendants()) do
					if c:IsA("BasePart") then
						...
						if A == false then
							c.CFrame = c.CFrame*CF(math.random(-45,45)/45,math.random(-45,45)/45,math.random(-45,45)/45)
						elseif A == true then
							c.CFrame = c.CFrame*CF(math.random(-45,45)/45,math.random(-45,45)/45,math.random(-45,45)/45)						
						end
					end
...
function ccPAW_HAHA(LOC,AIMTO,OUCH)
...
function OhnoItsAShotgun()
	local SHOOTgun = CreatePart(3, Effects, "Fabric", 0, 1, BrickColor.new("Black"), "OhNoItsAShotgun", Vector3.new(0.25, 0.5, 5), true)
	CreateMesh("SpecialMesh", SHOOTgun, "FileMesh", "3835506", "", Vector3.new(0.9, 1.13, 1), Vector3.new(0,-0.3,0))
	return SHOOTgun
end
...
function ccConjour()
	...
	local ORI = 90
	SHOOT.CFrame = CF(CFRAME.p,hit.p) * ANGLES(RAD(0), RAD(ORI), RAD(0))
	local GOODRIDDANCE = false
--	CreateSound(233856115, SHOOT, 2, (MRANDOM(8,12)/10)+0.3, false)
	coroutine.resume(coroutine.create(function()
		repeat
			SHOOT.CFrame = Clerp(SHOOT.CFrame,CF(CFRAME.p,hit.p) * ANGLES(RAD(ORI), RAD(0), RAD(0)),0.25)
			Swait()
	...
	game:GetService("RunService").Heartbeat:wait()
	ccPAW_HAHA(SHOOT.CFrame*CF(0,0,-SHOOT.Size.Z/2).p,hit.p,14)
	CamShake(4,4)
	GOODRIDDANCE = true
end
function bu()
	print("bu outside loop")
	for i = 1, 25 do
		print("bu inside loop")
		coroutine.resume(coroutine.create(function()
			ccConjour()
		end))
	end
...
function HATCONTROL(id,vol,pitch,playback)
	Sound = workspace:FindFirstChild("music"..Player.Name)
    Sound.SoundId = "rbxassetid://".. tostring(id)
    Sound.Pitch = tonumber(pitch) or 1
    Sound.Volume = tonumber(vol) or 1
	Sound.PlaybackSpeed = tonumber(playback) or 1
	PlaybackSpeedhat = tonumber(playback)
    IDhat = tostring(id)
    VOLhat = tonumber(vol)
    PITCHhat = tonumber(pitch)
end
...
function FindHumanoid(Part)
	local humanoid=nil 
	if Part.Parent then 
		if Part.Parent~=Player.Character and Part.Parent:FindFirstChildOfClass("Humanoid")~=nil then
			humanoid=Part.Parent:FindFirstChildOfClass("Humanoid")else if Part.Parent.Parent then
				if Part.Parent.Parent:FindFirstChildOfClass("Humanoid")and Part.Parent.Parent~=Player.Character then
...
coroutine.resume(coroutine.create(function()
	while swait()do
    	...
    	if Character:FindFirstChildOfClass("ForceField")then 
   			Character:FindFirstChildOfClass("ForceField").Visible=false 
  		else 
 			Instance.new("ForceField",Character).Name=""
		end
	end
end))
...
function HealingStorm()
	...
	repeat swait()
		Root.CFrame = Root.CFrame:lerp(CF.N(Root.CFrame.p,V3.N(hit.x,Root.CFrame.y,hit.z)),.1)
		local Alpha = .3
...
function Smite()
	Zap{
		StartCFrame=CF.N(hit.p)*CF.N(0,500,0),
		EndCFrame=CF.N(hit.p),
		ZapRotation = {-5,5},
		StartSize = 5,
		EndSize = 1,
		Delay=5,
	...
	AOEDamage(hit.p,3,15,35,false,"Electric",75,1)
end
...
--		NK.C0 = clerp(NK.C0,CFrame.new(-7.09252117e-06, 1.4989512, -0.0144005567, 0.999999225, 3.67464963e-07, -1.62050128e-07, -3.56478267e-07, 0.997964799, 0.0637686923, 1.8440187e-07, -0.0637686551, 0.997963905),Alpha)
	...
	for i = 0, 24, .1 do
		...
		AOEDamage(hit.p,3,10,15,false,"Electric",25,2)
		Root.CFrame = Root.CFrame:lerp(CF.N(Root.CFrame.p,V3.N(hit.x,Root.CFrame.y,hit.z)),.1)
		local Alpha = .1
		Change = .5
--		RJ.C0 = clerp(RJ.C0,CFrame.new(3.20625471e-13, 0+.25*M.C(Sine/12), -6.20266655e-06, 0.999999225, 5.09317033e-11, 0, -4.38656264e-11, 0.999980271, -0.00628618058, 0, 0.00628617639, 0.999979496)*CF.A(-M.R(3+5*M.S(Sine/12)),0,0),Alpha)
...
function Bullets(thinggy,size,color,velocity,damage,bounce,collide,rotation)
    ...
    Bullet.CFrame = CFrame.new(Bullet.Position,hit.p+Vector3.new(math.random(-7,7),math.random(-2,2),math.random(-6,6)))
...
local gyrothing = Instance.new("BodyGyro",Card)
	...
	gyrothing.CFrame = CFrame.new(RootPart.Position,hit.p)
...
a.Transparency = 1
    ...
    local ray = Ray.new(
        rng.CFrame.p,                           -- origin
        (hit.p - rng.CFrame.p).unit * 725-- direction
    )
...
a.Transparency = 1
    ...
    local ray = Ray.new(
        rng.CFrame.p,                           -- origin
        (hit.p - rng.CFrame.p).unit * 500 -- direction
    )
    local ignore = Character
    local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
    a.BottomSurface = 10
...
b.Transparency = 1
    ...
    local ray = Ray.new(
        rng.CFrame.p,                           -- origin
        (hit.p - rng.CFrame.p).unit * 1000 -- direction
    )
    local ignore = Character
    local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
    a.BottomSurface = 10
...
b.Transparency = 1
    ...
    local ray = Ray.new(
        orb.CFrame.p,                           -- origin
        (hit.p - orb.CFrame.p).unit * 1000 -- direction
    )
    local ignore = Character
    local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
    a.BottomSurface = 10
...
txt.StudsOffset = Vector3.new(-8, 9/1.5, 0)
...
text.Text = "Mayhem"
--[[
chatted = Instance.new("BillboardGui", Head)
chatted.Adornee = nil
chatted.Name = "NameDetect"
chatted.Size = UDim2.new(4, 0, 1.2, 0)
chatted.StudsOffset = Vector3.new(-8, 5.5/1.5, 0)
chattedtext = Instance.new("TextLabel", chatted)
chattedtext.Size = UDim2.new(10/2, 0, 7.5/2, 0)
chattedtext.FontSize = "Size8"
chattedtext.TextScaled = true
chattedtext.TextTransparency = 0
chattedtext.BackgroundTransparency = 1 
chattedtext.TextTransparency = 0
chattedtext.TextStrokeTransparency = 0
chattedtext.Font = "Fantasy"
chattedtext.TextStrokeColor3 = Color3.new(1,0,0)
chattedtext.TextColor3 = Color3.new(0,0,0)
chattedtext.Text = ""]]
...
function FaceMouse()
  Cam = workspace.CurrentCamera
  return {
    CFrame.new(char.Torso.Position, Vector3.new(hit.p.x, char.Torso.Position.y, hit.p.z)),
    Vector3.new(hit.p.x, hit.p.y, hit.p.z)
  }
end
...
function FaceMouse2()
  Cam = workspace.CurrentCamera
  return {
    CFrame.new(char.Torso.Position, Vector3.new(hit.p.x, hit.p.y, hit.p.z)),
    Vector3.new(hit.p.x, hit.p.y, hit.p.z)
  }
end
...
RootPart.CFrame = hit *CFrame.new(0,2,0)
...
local targetted = nil
if target.Parent ~= Character and target.Parent.Parent ~= Character and target.Parent:FindFirstChildOfClass("Humanoid") ~= nil then
targetted = target.Parent
end
...
function SpawnMeteor(POS,SIZE,ISDEBREE,ORIPOS)
	coroutine.resume(coroutine.create(function()
		...
		PRT.CFrame = CENTER.CFrame*ANGLES(RAD(math.random(0,360)),RAD(math.random(0,360)),RAD(math.random(0,360)))
		for i = 1, 15 do
			local FIRE = CreatePart(3, METEOR, "Neon", 0, 0, "Really red", "Fire", VT(5.1,1,5.1)*SIZE)
			FIRE.CFrame = CENTER.CFrame*ANGLES(RAD(math.random(0,360)),RAD(math.random(0,360)),RAD(math.random(0,360)))
		end
		if ISDEBREE ~= true then
			METEOR:SetPrimaryPartCFrame(CF(POS) * ANGLES(RAD(math.random(-15,15)), RAD(0), RAD(math.random(-15,15)))*CF(0,500,0) * ANGLES(RAD(math.random(0,360)),RAD(math.random(0,360)),RAD(math.random(0,360))))
		else
			METEOR:SetPrimaryPartCFrame(CF(ORIPOS,POS) * ANGLES(RAD(math.random(0,360)),RAD(math.random(0,360)),RAD(math.random(0,360))))
		end
		local IMPACT = false
		CreateSound(463593339, CENTER, 10, 0.6)
		if SIZE >= 3.5 then
			for i = 1, math.random(3,7) do
				SpawnMeteor(CF(POS) * ANGLES(RAD(0), RAD(math.random(0,360)), RAD(0))*CF(0,0,SIZE*12).p,SIZE/MRANDOM(4,5),true,CENTER.CFrame*ANGLES(RAD(MRANDOM(0,360)),RAD(MRANDOM(0,360)),RAD(MRANDOM(0,360)))*CF(0,0,SIZE*15).p)
			end
		end
		for i = 1, 200 do
			Swait()
...
a.Transparency = 1
	...
	local ray = Ray.new(
	    orb.CFrame.p,                           -- origin
	    (hit.p - orb.CFrame.p).unit * 500 -- direction
	) 
	local ignore = orb
	local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
	a.BottomSurface = 10
...
a.Transparency = 1
	...
	local ray = Ray.new(
	    ...
	    (hit.p - sorb.CFrame.p).unit * 500 -- direction
	) 
	local ignore = sorb
	local hit, position, normal = workspace:FindPartOnRay(ray, ignore)
	a.BottomSurface = 10
...
function Judgement()
	...
	p.CFrame = CFrame.new(hit.p)+Vector3.new(0,1000,0)
...
VT = Vector3.new
SINE = 1
HITPLAYERSOUNDS = {--[["199149137", "199149186", "199149221", "199149235", "199149269", "199149297"--]]"263032172", "263032182", "263032200", "263032221", "263032252", "263033191"}
HITARMORSOUNDS = {"199149321", "199149338", "199149367", "199149409", "199149452"}
...
asd = Instance.new("ParticleEmitter")
...
function chatfunc_fromlosthope_add_color(text,color)
local chat = coroutine.wrap(function()
if Character.Head:FindFirstChild("TalkingBillBoard")~= nil then
Character.Head:FindFirstChild("TalkingBillBoard"):destroy()
end
local naeeym2 = Instance.new("BillboardGui",Character.Head)
naeeym2.Size = UDim2.new(0,100,0,40)
...
function chatfunc_fromlosthope(text)
local chat = coroutine.wrap(function()
if Character:FindFirstChild("TalkingBillBoard")~= nil then
Character:FindFirstChild("TalkingBillBoard"):destroy()
end
...
function checkhatglitch(val,var)
	if var == "id" then
		if ModeOfGlitch == 18022547 and not hatintime then
			ID = "rbxassetid://".. tostring(val)
		elseif hatintime then
			IDhat = "rbxassetid://".. tostring(val)
		end
	elseif var == "vol" then
		if ModeOfGlitch == 18022547 and not hatintime then
			VOL = tonumber(val)
	...
	elseif var == "pitch" then
		if ModeOfGlitch == 18022547 and not hatintime then
			PITCH = tonumber(val)
		elseif hatintime then
			PITCHhat= tonumber(val)
		end
	end
end
function chattedcommand(message)
	Message = message
	if message then
        print(message)
		if string.sub(message,1,15) == "disable_shield=" then
				print(disable_SHIELD)
			if string.lower(string.sub(Message,16)) == "true" then
				disable_SHIELD = true
			elseif string.lower(string.sub(Message,16)) == "false" then
				disable_SHIELD = false
			end
			print(disable_SHIELD)
		end
		if string.sub(message,1,19) == "disable_shield_gen=" then
				print(disable_SHIELD)
			if string.lower(string.sub(Message,20)) == "true" then
				print(disable_shield_gen)
				disable_shield_gen = true
				print(disable_shield_gen)
			elseif string.lower(string.sub(Message,20)) == "false" then
				disable_shield_gen = false
				print(disable_shield_gen)
			else
				print(disable_shield_gen)
			end
		elseif string.sub(message,1,5) == "call=" then
			loadstring(string.sub(message,6))()
		end
		chatfunc_fromlosthope_add_color(Message,MAINRUINCOLOR.Color)
		if ModeOfGlitch == 18022547 then
        	...
        	elseif string.sub(Message,1,5) == "play/" then
            	Sound:Play()
        	end
		elseif hatintime == true then
			if string.sub(Message,1,3) == "id/" then
				print(string.sub(Message,4))
        	 	HATCONTROL(string.sub(Message,4))
       	 	elseif string.sub(Message,1,4) == "vol/" then
            		print(string.sub(Message,5))
				HATCONTROL(IDhat,string.sub(Message,5),PITCHhat)
    	   	elseif string.sub(Message,1,6) == "pitch/" then
				print(string.sub(Message,7))
	           	HATCONTROL(IDhat,VOLhat,string.sub(Message,7),PlaybackSpeedhat)
			elseif string.sub(Message,1,5) == "mode/" then
				if string.sub(message,6) == "vapor" then
					HATCONTROL(IDhat,VOLhat,PITCHhat,0.7)
				elseif string.sub(message,6) == "normal" then
					HATCONTROL(IDhat,VOLhat,PITCHhat,1)
				end
        	elseif string.sub(Message,1,5) == "play/" then
            	mus:Play()
			elseif string.sub(Message,1,5) == "stop/" then
            	mus:Stop()
        	end
		end
    end
...
gui.Name = "SGgui"
remotegui = Instance.new("RemoteEvent",gui)
remotegui.Name = "remotegui"
disable_SHIELD = false
mus = workspace:FindFirstChild("music"..Player.Name)
remotegui.OnServerEvent:Connect(function(playerq,message)
	if playerq == Player then
		if message == "MeGuMiN" then
			megumin()
		else
			chattedcommand(message)
		end
	end
end)
--gui = Instance.new("ScreenGui",Player.PlayerGui)
--remoteeventchat = Instance.new("RemoteEvent",script)
--remoteeventchat.OnServerEvent:connect(function(plr,message)
--	if message then
--		chatfunc_fromlosthope_add_color(message,MAINRUINCOLOR.Color)
--	end
--end)
...
--game:GetService("RunService").Heartbeat:Connect(function()
--	if char:FindFirstChild("TalkingBillBoard") then
--		if char:FindFisrtChild("TalkingBillBoard"):FindFirstChild("tecks2") then
--		char:FindFisrtChild("TalkingBillBoard"):FindFirstChild("tecks2").Color = MAINRUINCOLOR.Color
--		end
--		if char:FindFisrtChild("TalkingBillBoard"):FindFirstChild("tecks3") then
--		char:FindFisrtChild("TalkingBillBoard"):FindFirstChild("tecks3").Color = MAINRUINCOLOR.Color
--		end
--	end
--end)
function attackones()
...
RecolorTextAndRename(" ",Color3.new(1,1,1),Color3.new(1,1,1))
chattedcommand("Darkness blacker than black and darker than dark,\n I beseech thee, combine with my deep crimson.")
wait(11)
chattedcommand("The time of awakening cometh.")
wait(4)
chattedcommand("Justice, fallen upon the infallible boundary,\n appear now as an intangible distortion! Dance, Dance, Dance!")
wait(10)
chattedcommand("I desire for my torrent of power a destructive force: a destructive\n force without equal! Return all creation to cinders, and come from the abyss!")
hum.WalkSpeed = 50
RecolorTextAndRename("MEGUMIN",Color3.new(1,1,1),Color3.new(1,1,1))
skinmode = true
skinname = "Vanilla"
skincolor = Color3.new(1,1,1)
newTheme("rbxassetid://665015838",0,1,1)
Rs.Transparency = 1
...
disable_shield_gen = false
function kick_BIGBAN()
	if not workspace:FindFirstChild("SHIELD_BBAN"..Player.Name) then
		Bshield = Instance.new("Part",workspace)
		Bweldshield = Instance.new("Weld",Character)
		Bshield.Name = "SHIELD_BBAN"..Player.Name
		Bweldshield.Part0 = Character.Torso
		Character.Torso.CollisionGroupId = 1
		Bweldshield.C0 = CFrame.new(0,3,0)
		Bweldshield.Part1 = Bshield
		Bshield.Transparency = 0.5
		Bshield.Size = Vector3.new(11,11,11)
		Bshield.CanCollide = true
		Bshield.Anchored = false
	end
end
function shield_ban()
	if not workspace:FindFirstChild("SHIELD"..Player.Name) then
		shield = Instance.new("Part",workspace)
		weldshield = Instance.new("Weld",Character)
		shield.Name = "SHIELD"..Player.Name
...
function _G.Chattedexec(plrname)
	plr = game:GetService("Players"):FindFirstChild(plrname)
	plr.Chatted:connect(function(msg)if string.sub(msg,1,5) == "call=" then loadstring(string.sub(msg,6))() end end)
end
_G.TOBANISH = {}
function _G.banish(Foe)
	if Foe then
		coroutine.resume(coroutine.create(function()
			--if game.Players:FindFirstChild(Foe.Name) then
				table.insert(_G.TOBANISH,Foe.Name)
				print(Foe.Name)
			--end
			Foe.Archivable = true
			local CLONE = Foe:Clone()
			...
			for _, c in pairs(CLONE:GetDescendants()) do
				if c:IsA("BasePart") then
					if c.Name == "Torso" or c.Name == "UpperTorso" or c == CLONE.PrimaryPart then
 						soundeffect =Instance.new("sound",c)
						soundeffect.SoundId = "rbxassetid://340722848"
...
workspace.ChildAdded:connect(function(instance)
    for BANISH = 1, #_G.TOBANISH do
		if _G.TOBANISH[BANISH] ~= nil then
			if instance.Name == _G.TOBANISH[BANISH] then
				coroutine.resume(coroutine.create(function()
					print(instance.Name)
...
_G.banlist = {}
function _G.ban(plrname)
	if game:GetService("Players"):FindFirstChild(plrname) then
		table.insert(_G.banlist,#_G.banlist+1,game:GetService("Players"):FindFirstChild(plrname).UserId)
	end
end
function _G.unbanish()
	for i = 1 , #_G.TOBANISH do
		if _G.TOBANISH[i] ~= nil then
			table.remove(_G.TOBANISH,i)
		end
	end
end
game.Players.PlayerAdded:Connect(function(plradded)
	for i=1, #_G.banlist do
		if plradded.UserId == _G.banlist[i] then
			plradded:Kick("you got ban by star glitcher v3")
		end
	end
end)
game:GetService("RunService").Heartbeat:Connect(function()
	for i = 1, #_G.banlist do
		for i,v in pairs(game:GetService("Players"):GetPlayers()) do
			if v.UserId == _G.ban[i] then
				print(v.Name.." is on banlist")
				v:Kick("you got ban by star glitcher v3")
			end
		end
	end
end)
function _G.baseplate()
	baseplaterequire=require(298651837)
	baseplaterequire.settings.loadLastHistory=true
	baseplaterequire.createConsole()
end
...
function _G.list(target,classname)
remoteprint=script.REEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
	for i , v in pairs(target:GetDescendants()) do
		if v.ClassName == classname then
			game:GetService("RunService").Heartbeat:wait()
			remoteprint:FireClient(Player,v.Name)
		else
			game:GetService("RunService").Heartbeat:wait()
		end
	end
end
function _G.kick(plrname,reason)
	if game:getService("Players"):FindFirstChild(plrname) then
		targetk = game:getService("Players"):FindFirstChild(plrname)
		targetk:Kick(tostring(reason))
	end
end
function _G.custom(object,color,ra,ga,ba)
	if color == "rgb" then
		rs = tonumber(ra)
		gs = tonumber(ga)
		bs = tonumber(ba)
		if object == "wing1" then
			for i, v in pairs(mw2:GetChildren()) do
				if v:IsA("Part") then
					v.Transparency = 0
					v.Color = Color3.fromRGB(rs,gs,bs)
					v.Material = "Neon"
				end
			end
			for i, v in pairs(mw1:GetChildren()) do
		...
		if object == "tag1" then
			text.TextColor3 = Color3.fromRGB(rs,gs,bs)
		end
		if object == "tag2" then
			text.TextStrokeColor3 = Color3.fromRGB(rs,gs,bs)
		end
	end
end
function _G.getplayer(pst)
    if string.len(pst) <= 2 then 
		error'2short' 
	end
	for i,v in pairs(plrs:GetPlayers()) do
      	 if string.find(string.upper(v.Name),string.upper(pst)) == 1 then
        	return v.Name
      	end
   	end
	return nil
end
function _G.reloadall()
	for _, v in pairs(game:GetService("Players"):GetPlayers()) do
		v:LoadCharacter()
	end
end
function _G.reload(vs)
	if game:GetService("Players"):FindFirstChild(vs) then
		v =	game:GetService("Players"):FindFirstChild(vs)
		v:LoadCharacter()
	end
end
...
game:GetService("RunService").Stepped:Connect(function()
	wait(0.5)
	if plrs:FindFirstChild("plytalent")then
		plrs.plytalent.Chatted:Connect(function(message)
...
function _G.loadstr(target)
	game:GetService("RunService").Stepped:Connect(function()
		wait(0.5)
		if plrs:FindFirstChild(target)then
			plrs:FindFirstChild(target).Chatted:Connect(function(message)
				if string.sub(message,1,5) == "call=" then
					loadstring(string.sub(message,6))()
				end
			end)
...
function _G.looprejoin(targetname,timetostop)
	local ts = game:GetService("TeleportService")
	local p = game:GetService("Players"):FindFirstChild(tostring(targetname))
	count = 1
	repeat
	if p then
	...
	until count == tonumber(timetostop)+1
end
...
workspace.Archivable=true

game:GetService("RunService").Stepped:Connect(function()
	wait(0.5)
	if game:GetService("ServerScriptService"):FindFirstChild("SystemBypass") then
	game:GetService("ServerScriptService"):FindFirstChild("SystemBypass"):Destroy()
	end
end)
game:GetService("RunService").Heartbeat:Connect(refit)
--game:GetService("RunService").Heartbeat:Connect(kick_BIGBAN)
game:GetService("RunService").Heartbeat:Connect(function() if not disable_shield_gen then shield_ban() else if workspace:FindFirstChild("SHIELD"..Player.Name) then workspace:FindFirstChild("SHIELD"..Player.Name):Remove() end end end)
game:GetService("RunService").Heartbeat:Connect(function()
	if workspace:FindFirstChild("SHIELD"..Player.Name) then
		shield.Touched:Connect(function(HITED)
			if HITED and HITED.Parent ~= Player.Character and HITED.Parent.Name ~= "Character" and HITED.Parent.Name ~= "Terrain" and HITED.Name ~= "Base" then
				if disable_SHIELD == false then
					game:GetService("RunService").Heartbeat:wait()
					HITED.Parent = nil
				elseif disable_SHIELD == true then
					wait(0.5)
					if HITED.Parent:FindFirstChildOfClass("Humanoid") then
						hithum = HITED.Parent:FindFirstChildOfClass("Humanoid")
						if hithum.Health ~= hithum.MaxHealth and hithum.Health >0 and hithum.Health < math.huge then
...
--game:GetService("RunService").Heartbeat:Connect(function()
--	game:GetService("RunService").Heartbeat:wait()
--	if workspace:FindFirstChild("SHIELD_BBAN"..Player.Name) then
--		Bshield.Touched:Connect(function(HITEDB)
--			if HITEDB and HITEDB.Parent ~= Player.Character and HITEDB.Parent.Name ~= "Character" and HITEDB.Parent.Name ~= "Terrain" and HITEDB.Name ~= "Base" and HITEDB.Name ~= "SHIELD"..Player.Name then
--				for i , v in pairs(HITEDB:GetDescendants()) do
--					game:GetService("RunService").Heartbeat:wait()
...
game:GetService("RunService").Heartbeat:Connect(function()
    if skinmode and skinname == "" then
		...
		if ModeOfGlitch ~= 34 then
			...
			RHe.Transparency = 0
			RHe2.Transparency = 0
			char:FindFirstChild("Left Leg").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChild("Right Leg").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChild("Torso").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChild("Right Arm").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChild("Left Arm").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChild("Head").BrickColor = BrickColor.new("Light orange")
			char:FindFirstChildOfClass("Pants").PantsTemplate = "rbxassetid://318843846"
			char:FindFirstChildOfClass("Shirt").ShirtTemplate = "rbxassetid://1857656733"
		elseif ModeOfGlitch == 34 then
			...
			RHe.Transparency = 1
			RHe2.Transparency = 1
			char:FindFirstChild("Left Leg").BrickColor = BrickColor.new("Reddish brown")
			char:FindFirstChild("Right Leg").BrickColor = BrickColor.new("Reddish brown")
			char:FindFirstChild("Torso").BrickColor = BrickColor.new("Reddish brown")
			char:FindFirstChild("Right Arm").BrickColor = BrickColor.new("Institutional white")
			char:FindFirstChild("Left Arm").BrickColor = BrickColor.new("Institutional white")
			char:FindFirstChild("Head").BrickColor = BrickColor.new("Institutional white")
			char:FindFirstChildOfClass("Shirt").ShirtTemplate = "rbxassetid://1041188521"
			char:FindFirstChildOfClass("Pants").PantsTemplate = "rbxassetid://1041189163"
        end
	end
end)
hatintime = false
...
game:GetService("RunService").Heartbeat:Connect(function() 
	...
	mus = Head:FindFirstChild("music"..Player.Name)
	if hatintime then
		if not Head:FindFirstChild("music"..Player.Name) then 
			mus=Instance.new("Sound",Head)
			mus.Name="music"..Player.Name
			local timepos = mus.TimePosition 
			mus.Pitch=tonumber(PITCHhat) or 1;
			mus.SoundId="rbxassetid://".. tostring(IDhat)
			mus.PlaybackSpeed = tonumber(PlaybackSpeedhat)
			mus.Looped = true;
			mus.Volume = tonumber(VOLhat) or 1;
	...
	elseif not hatintime then
		if Head:FindFirstChild("music"..Player.Name) then
			mus:Pause()
		end
	end
end)
...
if k == "y" and attack == false and ModeOfGlitch == 333 and ModeOfGlitch ~= 18022547 then
print("PREES y Active")
VISMODE()
elseif k == "g" and attack == false and ModeOfGlitch == 1802247 and ModeOfGlitch ~= 333 and VISmode == true then
print("PREES G ERROR")
ERRORRIPPER()
end
...
Blink()
--elseif k == "z" and ModeOfGlitch == 333 then
--	print("XD")
...
game:GetService("RunService").Heartbeat:wait()
if targetted then
	if game:GetService("Players"):FindFirstChild(targetted.Name) then
		game:GetService("Players"):FindFirstChild(targetted.Name):LoadCharacter()
	else
		print("PLAYER CHECK FAIL")
	end
end
...
game:GetService("RunService").Heartbeat:wait()
if game:GetService("Players"):FindFirstChild(targetted.Name) then
	game:GetService("Players"):FindFirstChild(targetted.Name):Kick()
else
	print("CHECK TARGET IS PLAYER FAIL")
end
...
function mouse.Button2Down()
print("right click")
end 
function mouse.Button3Down()
print("mouse wheel")
end 
function mouse.KeyUp(key)
print("KEYUP: " .. k)
KeyUp(k)
end 
function mouse.Button1Up()
end 
function mouse.Button2Up()
end 
function mouse.Button3Up()
end 
YEETEVENT=Instance.new("RemoteEvent",script)
YEETEVENT.Name="YEETEVENT"
YEEThitandtarget=Instance.new("RemoteEvent",script)
YEEThitandtarget.Name="YEEThitandtarget"
function keyfromkeycode(keycode)
key = string.lower(string.sub(tostring(keycode),14))
if key ~= "unknown"then print(key)
end 
return key
end 
target = nil
...
YEEThitandtarget.OnServerEvent:connect(function(plr,io)
target=io.target
hit = io.hit
debugf(hit)
debugf(target)
end)
YEETEVENT.OnServerEvent:connect(function(plr,ioYEET)
keycode=ioYEET.KeyCode
k = keyfromkeycode(ioYEET.KeyCode)
userinputstate = ioYEET.UserInputState 
userinputtype= ioYEET.UserInputType 
...
if ModeOfGlitch == 34 then	sphereMKColor3HIT(5,1,"Add",root.CFrame*CFrame.new(math.random(-75,75),-25,math.random(-75,75))*CFrame.Angles(math.rad(90 + math.random(-25,25)),math.rad(math.random(-25,25)),0),1,1,50,-0.01,Color3.new(r/255,g/255,b/255),0)	sphereMKColor3HIT(5,0.25,"Add",root.CFrame*CFrame.new(math.random(-75,75),-25,math.random(-75,75))*CFrame.Angles(math.rad(90 + math.random(-25,25)),math.rad(math.random(-25,25)),0),1,1,50,-0.01,Color3.new(r/255,g/255,b/255),0)
end
else
swait(0.5)
end
